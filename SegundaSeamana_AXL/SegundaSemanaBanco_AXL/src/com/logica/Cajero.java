...
public class Cajero implements IMetodos{
	...
	//Declara una variable auxiliar para incrementar el folio 
	//en nuestro ticket
	private int folio=1;
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		//Entonces asignamos porteriormente la cuenta si existe en el HashMap
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		//Vamos a buscar la cuenta y necesitamos unas validaciones
		//Primero si se encuntra o localiza la cuenta, la asignamos
		//para manipularla}
		if(consultar(numeroCuenta)!=null) {
			...
			if(monto>9000) {//Validamos si el monto excede el maximo del cajero
				System.out.println("El monto excede el maximo permito por el cajero: ");
				return ticket;
			}else if(cuenta.getSaldo()<monto) {//si el monto es menor a retirar
				System.out.println("Saldo insuficiente para realizar el retiro");
				return ticket;
			}else if(cuenta.getSaldo()-monto<cuenta.getSaldoMin()) {
				System.out.println("El retiro quedaria por debajo del minimo a la cuenta");
				return ticket;
			}else {//Si el retiro puede realizarse 
				//Actualizamos el estado de nuestra cuenta
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		if(consultar(numeroCuenta) !=null) {
			...
			System.out.println("No haay una cuenta asociada a ese cliente");
			return ticket;
		}
