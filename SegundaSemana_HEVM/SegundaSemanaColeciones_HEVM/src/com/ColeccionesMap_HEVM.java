...
public class ColeccionesMap_HEVM {
	...
	public static void main(String[] args) {
		...
		//para almacenar claves de un tipo Integer y elementos tipo String
		...
		//Imprimir en pantalla un solo valor almacenado en una determinada clase
