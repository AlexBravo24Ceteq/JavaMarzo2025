	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > 9000) {// validamos si el monto excede el maximo del cajero
				...
				System.out.println("Saldo insuficiente para realizar su retiro");
				return ticket;
				...
				// Entonces ahora si emitimos nuevo ticket
	...
	public Ticket depositar(int numeroCuenta, double monto) {
		...
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > cuenta.getSaldoMax()) {
				System.out.println("El monto a depositar excede el maximo en la cuenta");
				return ticket;
