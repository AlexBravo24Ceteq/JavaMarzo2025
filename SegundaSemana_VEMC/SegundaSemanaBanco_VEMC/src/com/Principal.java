...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//Para agregar cuentas en nuestro HashMap existen dos formas
		...
		//Si recordamos, para recuperar el valor de un objeto en mi HashMap
		...
		//Quiero retirar dinero de una cuenta inexistente.
