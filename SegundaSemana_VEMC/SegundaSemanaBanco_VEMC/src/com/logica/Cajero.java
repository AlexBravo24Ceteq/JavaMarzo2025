...
public class Cajero implements IMetodos {
	...
	//Vamos  a declarar unos atributos de nuesto cajero.
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		Cuenta cuenta = null;
		//Entonces asignamos posteriormente la cuenta 	que existe en el HashMap
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		Ticket ticket = null;
		//Verificar la cuenta y necesitamos hacer unas validaciones
		//1.-Si se encuentra o localiza una cuenta la asignamos para mamipularla
		if(consultar(numeroCuenta) !=null) {
			...
			if(monto > 9000) {//Validamos si el monto a retirar excede el maximo que delimita el cajero.
				...
				System.out.println("El retiro dejaria un saldo por debajo de lo minimo en la cuenta.");
				return ticket;
